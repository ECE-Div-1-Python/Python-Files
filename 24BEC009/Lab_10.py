...
create_csv("24BEC009_LabDay10/output_10.01.csv")
...
print("\n")
read_csv_to_dict_and_update("24BEC009_LabDay10\Student-Data.csv")
print("\n")
...
"""
        ...
        filepath = os.path.join("24BEC009_LabDay10/", filename)
...
source = "24BEC009_LabDay10/test_10.05.txt"
destination = "24BEC009_LabDay10/output_10.05.txt"
...
# Example usage
file1 = '24BEC009_LabDay10/test_10.05.txt'
file2 = '24BEC009_LabDay10/test_10.08.txt'
output_file = '24BEC009_LabDay10/output_10.06.txt'
...
with open("24BEC009_LabDay10/employee.json", "w") as file:
...
with open("24BEC009_LabDay10/employee.json", "r") as file:
...
remove_articles('24BEC009_LabDay10/test_10.08.txt', '24BEC009_LabDay10/output_10.08.txt')